...
import { generateAgentPickerPageImports } from "./generate-agent-picker-page-imports.mjs";
...
const { draftsRoot, pageImportsConfigPath } = resolveHostPaths(appRoot);

mkdirSync(draftsRoot, { recursive: true });

generateAgentPickerDrafts(appRoot);
generateAgentPickerPageImports(appRoot);
...
const pageImportsWatcher = watch(pageImportsConfigPath, () => {
