...
import { agentPickerViewports, type AgentPickerComponentItem, type AgentPickerViewport } from "../lib/types";

interface AgentPickerPreviewProps {
  item: AgentPickerComponentItem;
  viewport: AgentPickerViewport;
  propsPatch?: Record<string, unknown>;
}

export default function AgentPickerPreview({ item, viewport, propsPatch }: AgentPickerPreviewProps) {
  ...
  return (
    <div
      className="agent-picker-scrollbar-soft flex h-full w-full items-start justify-center overflow-auto rounded-[1.8rem] bg-white shadow-[0_18px_44px_rgba(15,23,42,0.08)]"
